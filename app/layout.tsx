...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'What luxury vacation rentals do you offer in Florida?', acceptedAnswer: { '@type': 'Answer', text: 'Casa Grandè is a 5-bedroom, 3-bathroom luxury vacation home at 18 N Maywood Ave, Clearwater, FL. Features a private pool, pet-friendly policy, and sleeps up to 16 guests. From $500/night.' } },
    ...
    { '@type': 'Question', name: 'What is the best large vacation rental near Yosemite?', acceptedAnswer: { '@type': 'Answer', text: 'Sierra Crest Haven in Oakhurst, CA is a luxury mountain estate near Yosemite with 6 bedrooms, game room, full bar, and mountain views. Sleeps up to 16 guests from $945/night.' } },
