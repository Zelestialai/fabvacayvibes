...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'What luxury vacation rentals do you offer in Florida?', acceptedAnswer: { '@type': 'Answer', text: 'Casa Grandè is a 5-bedroom luxury beach house in Clearwater, FL with a private pool, pet-friendly policy, and walking distance to Pier 60. From $500/night.' } },
